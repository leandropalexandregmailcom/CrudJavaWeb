 ...
 * @author mazza
 */
@WebServlet(name = "ControllerFactory", urlPatterns = {"/controller/*"})
public class ControllerFactory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            url = url.replace(request.getContextPath()+"/controller/","").replaceAll("/", ".");
            
            String className = "controller.command." + url;
            Class classAction = Class.forName(className);
            
            Command commandAction = (Command) classAction.newInstance();
            
            String urlRetorno = commandAction.execute(request, response);
